...
RubyZip::InputStream.open('example.zip') do |zis|
...
RubyZip::OutputStream.open('exampleout.zip') do |zos|
...
RubyZip::File.open('exampleout.zip') do |zip_file|
...
part_zips_count = RubyZip::File.split('large_zip_file.zip', 2_097_152, false)
puts "Zip file splitted in #{part_zips_count} parts"

# Track splitting an archive
RubyZip::File.split('large_zip_file.zip', 1_048_576, true, 'part_zip_file') do |part_count, part_index, chunk_bytes, segment_bytes|
