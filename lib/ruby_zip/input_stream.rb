module RubyZip
  ...
  #   require 'ruby_zip'
  #
  #   RubyZip::OutputStream.open("my.zip") do |io|
  #
  ...
  #
  #
  #   RubyZip::InputStream.open("my.zip") do |io|
  #
  ...
  class InputStream
    ...
    def initialize(context, offset = 0, decrypter = nil)
      ...
      @decrypter     = decrypter || ::RubyZip::NullDecrypter.new
      @current_entry = nil
    end
    ...
    def open_entry
      ...
      if @current_entry && @current_entry.gp_flags & 8 == 8 && @current_entry.crc == 0 \
        ...
        raise GPFBit3Error,
              ...
              'Please use ::RubyZip::File instead of ::RubyZip::InputStream'
      end
    ...
    def get_decompressor
      ...
      when @current_entry.compression_method == ::RubyZip::Entry::DEFLATED
        ...
        ::RubyZip::Inflater.new(@archive_io, @decrypter)
      else
